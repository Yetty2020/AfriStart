...
function Hero() {
  return (
    ...
    <div className="min-h-screen md:h-screen flex flex-col items-center justify-center bg-[#1A0F1E] gap-6 font-Playfair px-5 " >
        ...
        <h1 data-cursor data-cursor-scale="3" data-cursor-bg="#FFFF" className="text-[#FFF1F2] font-black text-5xl lg:text-9xl">Built by women.</h1>
        <h1 data-cursor data-cursor-scale="2" data-cursor-bg="#FFFF" className="text-[#FFF1F2] font-black text-4xl lg:text-7xl italic">Built for founders.</h1>
