...
function Founder() {
  ...
  data-cursor-text="The Founder" className="text-white  flex flex-col gap-8 lg:gap-0 w-full border-b border-t border-[#FF6B00] pt-10" >
      ...
      <div className="relative flex justify-center items-center lg:px-30 p-10 lg:p-12 lg:border-r border-[#FF6B00] min-h-100">
        ...
        <div className="lg:w-[60%] flex flex-col gap-3 items-center justify-content  lg:p-5 font-medium  text-lg md:text-xl tracking-wider font-Playfair ">
           <div className="lg:w-[70%] flex flex-col gap-10 items-start ">
             <p className="p-7 md:px-15 lg:p-0 text-left">I'm an IP Lawyer and I started Afristarts solutions because I kept seeing the same story - founders with brilliant ideas, real talent and genuine ambition, who were being held back but not by their business, but by the structure around it.</p>
             <div className="relative">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="w-23 h-23 md:h-30 md:w-30 lg:hidden text-[#FF6B00] absolute -left-8 top-1 ">
  <path d="M12 2L22 12L12 22L2 12Z" strokeLinecap="square"/>
  <path d="M12 6L18 12L12 18L6 12Z" strokeOpacity="0.3"/>
</svg>
 <p className="ml-14 lg:ml-0 px-7 md:ml-20 md:px-15 lg:px-0 text-left">Missing CAC registration meant they couldn't apply for funding. No website meant clients could not take them seriously. No business plan meant banks turned they away. These were all solvable problems - and I wanted to build a firm that solved them.</p>
             </div>
             <div className="relative">
               <p className="mr-14 lg:mr-0 md:mr-20 md:p-15 p-7 lg:px-0 lg:p-0 text-left">Afristart is the result of that conviction. We put the pieces together so you can earn without stress.</p>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="w-23 h-23 md:h-30 md:w-30 lg:hidden text-[#FF6B00] absolute  -right-5 bottom-0">
